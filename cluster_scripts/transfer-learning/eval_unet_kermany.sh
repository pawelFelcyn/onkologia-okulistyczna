...
# Usage:
#   sbatch eval_unet_kermany.sh 13
...
MODEL_PATH="models/unet/kermany_transfer_seed${SEED}.pth"

echo "[INFO] Evaluating Kermany transfer UNet | seed=${SEED} | model=${MODEL_PATH}"
