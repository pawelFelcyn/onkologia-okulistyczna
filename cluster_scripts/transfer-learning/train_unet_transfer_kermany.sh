...
#   sbatch train_unet_transfer_kermany.sh 13 42
# Optional 3rd arg: explicit encoder weights path (overrides 2nd arg)
#   sbatch train_unet_transfer_kermany.sh 13 42 train_model/transfer_learning/runs_kermany_seed42/encoder_kermany_pretrained.pth
...
echo "[INFO] Kermany transfer UNet training | run_seed=${SEED} | kermany_seed=${KERMANY_SEED} | encoder=${ENCODER_WEIGHTS}"
